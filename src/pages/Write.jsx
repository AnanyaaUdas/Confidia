...
const Write = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!recipient.trim() || !message.trim()) {
      setError("Please enter a recipient and a compliment.");
      return;
    }
    ...
    try {
      ...
      setError(err?.message || "Could not post. Is the backend running on port 4000?");
    } finally {
      setPosting(false);
    }
  };
    ...
    <>
      ...
      <main className="write-page">
        <div className="write-intro">
          ...
          <p>Nobody will ever see your name. Only the messages pass moderation.</p>
        </div>
        ...
        <section className="write-layout">
          <div className="write-left">
            <div className="kindness-prompt">
              ...
              <button type="button" className="wheel-button" onClick={spinWheel}>
            ...
            <div className="info-cards">
              <div className="info-card">
                ...
                <p>Recipients can post an anonymous thank-you underneath.</p>
              </div>
              ...
              <div className="info-card">
                ...
                <p>Report a post and an admin reviews it — kindness stays kind.</p>
              </div>
            </div>
          </div>
          ...
          <form className="confession-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <p className="form-category">Where should this show up on the wall?</p>
            ...
            <p className="privacy-note">
              Your post stays anonymous. It's saved locally in your browser for this demo.
            </p>
